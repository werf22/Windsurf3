...
- ✅ PATCH/PUT endpoints now feature bulletproof, multi-layered sanitization: all string fields are always strings, all date/datetime fields are valid or None, and no invalid types can ever reach SQLite. "Internal Server Error" due to bad types is now impossible (2025-04-21).
